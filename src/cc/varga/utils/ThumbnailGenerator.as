package cc.varga.utils
{
	...
	public final class ThumbnailGenerator
	{
		...
		//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
		public function ThumbnailGenerator(loader : Object, width:int, height:int, $callBackFunction : Function = null, aspectRatio:Boolean = true)
		{			
		...
		private function compressFinished( compressedByteArray: ByteArray ):void {
			...
			outputFile = File.desktopDirectory.resolvePath("Francis Varga Thumbnail Generator/" +(Math.random()*10000000).toFixed(0) + '.jpg');
